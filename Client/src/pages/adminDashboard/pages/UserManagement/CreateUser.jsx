...
const UserFormModals = ({
  ...
  const handletheNext = () => {
    ...
    if (!employee_type || !is_verified || !company_id || !salary || !dateOfJoin || !pf_account || !UPI_Id) {
      toast.error("All fields are required")
      return
    }
  ...
  const submitData = async (e) => {
    e.preventDefault()
    try {
      const formattedData = { ...formData, employment_history: employmentHistory.length ? employmentHistory : [] }
    ...
    <>
      ...
      {addModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="absolute inset-0 bg-gray-500/50" onClick={() => setAddModalOpen(false)}></div>
                  ...
                  <div key={index} className="p-2 rounded-lg mb-2">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        value={job.company || ""}
                        onChange={(e) => handleEmploymentHistoryChange(e, index)}
