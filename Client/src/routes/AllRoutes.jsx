...
import NewPassword from "../components/Auth/Login/NewPassword.jsx";
...
const AllRoutes = () => {
  ...
  return (
    <Routes>
     ...
     {!token && <Route path="/forget-password" element={<ForgetPassword />} />}
     {!token && <Route path="/reset-password" element={<NewPassword />} />}
     {!token && <Route path="/otp" element={<OTP />} />}
